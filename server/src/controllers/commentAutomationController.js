...
function cleanPayload(body, userId) {
  return {
    ...
    followGateMessage: body.followGateMessage?.trim() || 'Please follow us first, then tap below to continue 👇',
    followGateButtonName: body.followGateButtonName?.trim() || "I've Followed ✅",
